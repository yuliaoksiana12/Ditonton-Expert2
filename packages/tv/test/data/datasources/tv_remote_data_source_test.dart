...
void main() {
  ...
  group('get Now Playing Tv', () {
    final tTvList =
        TvResponse.fromJson(json.decode(readJson('dummy_data/now_air.json')))
            .tvList;

    test('return list of Tv Model when the response code is 200', () async {
      // arrange
  ...
  group('get Popular Tv', () {
    ...
    test('return list of Tv when response is success (200)', () async {
      // arrange
